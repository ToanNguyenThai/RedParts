  ...
  return (
          ...
          <div className="header__topbar-start">
            <div className="topbar topbar--spaceship-start">
              ...
              <div className="topbar__item-text">
                <a className="topbar__link" href="about-us.html">
                  About Us
                </a>
              </div>
              <div className="topbar__item-text">
                <a className="topbar__link" href="contact-us-v1.html">
                  Contacts
                </a>
              </div>
              <div className="topbar__item-text">
            ...
            <div className="header__navbar-departments">
              <div className="departments">
                <button className="departments__button" type="button">
                  ...
                  <span className="departments__button-title">Menu</span>
                                ...
                                <ul className="megamenu__links megamenu-links megamenu-links--root">
                                  <li className="megamenu-links__item megamenu-links__item--has-submenu">
                                    ...
                                    <ul className="megamenu-links">
                                      <li className="megamenu-links__item">
                                        <a
                                          className="megamenu-links__item-link"
                                          href
                                        >
                ...
                <ul className="main-menu__list">
                  <li className="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                    ...
                    <div className="main-menu__submenu">
                      <ul className="menu">
                        ...
                        <li className="menu__item">
                          <a href="index2.html" className="menu__link">
                            Home Two
                          </a>
                        </li>
                  ...
                  <li className="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                    ...
                    <div className="main-menu__submenu">
                      <ul className="menu">
                        ...
                        <li className="menu__item">
                          <a href="shop-list.html" className="menu__link">
                            Shop List
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="shop-table.html" className="menu__link">
                            Shop Table
                          </a>
                        </li>
                        <li className="menu__item">
                        ...
                        <li className="menu__item">
                          <a href="checkout.html" className="menu__link">
                            Checkout
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="order-success.html" className="menu__link">
                            Order Success
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="wishlist.html" className="menu__link">
                            Wishlist
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="compare.html" className="menu__link">
                            Compare
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="track-order.html" className="menu__link">
                            Track Order
                          </a>
                        </li>
                      </ul>
                  ...
                  <li className="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                    ...
                    <div className="main-menu__submenu">
                      <ul className="menu">
                        <li className="menu__item">
                          <a href="account-login.html" className="menu__link">
                            Login &amp; Register
                          </a>
                        </li>
                        <li className="menu__item">
                        ...
                        <li className="menu__item">
                          <a href="account-garage.html" className="menu__link">
                            Garage
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="account-profile.html" className="menu__link">
                            Edit Profile
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="account-orders.html" className="menu__link">
                            Order History
                          </a>
                        </li>
                        <li className="menu__item">
                  ...
                  <li className="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                    ...
                    <div className="main-menu__submenu">
                      <ul className="menu">
                        <li className="menu__item">
                          <a href="about-us.html" className="menu__link">
                            About Us
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="contact-us-v1.html" className="menu__link">
                            Contact Us v1
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="contact-us-v2.html" className="menu__link">
                            Contact Us v2
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="404.html" className="menu__link">
                            404
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="terms.html" className="menu__link">
                            Terms And Conditions
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="faq.html" className="menu__link">
                            FAQ
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="components.html" className="menu__link">
                            Components
                          </a>
                        </li>
                        <li className="menu__item">
                          <a href="typography.html" className="menu__link">
                            Typography
                          </a>
                        </li>
                      </ul>
	...
	c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z"
                ...
                <div className="search__dropdown search__dropdown--vehicle-picker vehicle-picker">
                  ...
                  <div
                    className="vehicle-picker__panel vehicle-picker__panel--list vehicle-picker__panel--active"
                    data-panel="list"
                  >
                  ...
                  <div
                    className="vehicle-picker__panel vehicle-picker__panel--form"
                    data-panel="form"
                  >
                    <div className="vehicle-picker__panel-body">
                ...
                <div className="account-menu">
                  <form className="account-menu__form">
                    ...
                    <div className="form-group">
                      ...
                      <div className="account-menu__form-forgot">
                        ...
                        />
                        <a href className="account-menu__form-forgot-link">
                          Forgot?
                        </a>
                      </div>
                    </div>
                  ...
                  <a href className="account-menu__user">
                    ...
                    <div className="account-menu__user-info">
                      <div className="account-menu__user-name">Ryan Ford</div>
                  ...
                  <ul className="account-menu__links">
                    ...
                    <li>
                      <a href="account-dashboard.html">Garage</a>
                    </li>
                    <li>
	...
	c-0.6,0-1-0.4-1-1s0.4-1,1-1h15.5c0.8,0,1.5,0.4,2,1c0.5,0.6,0.6,1.5,0.4,2.2l-3.1,10C28.5,20.3,27.5,21,26.4,21z"
                ...
                <span className="indicator__value">$250.00</span>
              </a>
              <div className="indicator__content">
