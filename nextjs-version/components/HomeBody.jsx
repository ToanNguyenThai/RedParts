...
export default function HomeBody() {
  return (
    <div className="site__body">
      <div className="block-finder block">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url("/images/finder-1903x500.jpg")',
          }}
        />
        <div className="block-finder__body container container--max--xl">
          <div className="block-finder__title">Find Parts For Your Vehicle</div>
            ...
            <div className="section-header__body">
              ...
              <ul className="section-header__groups">
                <li className="section-header__groups-item">
                  <button
                    type="button"
                    className="section-header__groups-button section-header__groups-button--active"
                  >
                    All
                  </button>
                </li>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
          ...
          <div className="block-sale__body">
            ...
            <div
              ...
              style={{
                backgroundImage: 'url("/images/sale-1903x640.jpg")',
              }}
            />
            <div className="container">
              <div className="block-sale__carousel">
                <OwlCarousel className="owl-theme" items="5">
                  <div className="block-sale__item">
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z"
      ...
      <div className="block-space block-space--layout--divider-lg" />
                ...
                <div className="category-card__content">
                  <div className="category-card__info">
                    ...
                    <ul className="category-card__children">
                      ...
                      <li>
                        <a href="category-4-columns-sidebar.html">Tires</a>
                      </li>
                      <li>
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z"
      ...
      <div className="block-space block-space--layout--divider-sm" />
      <div className="block block-zone">
        <div className="container">
          <div className="block-zone__body">
            <div className="block-zone__card category-card category-card--layout--overlay">
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z"
      ...
      <div className="block-space block-space--layout--divider-nl" />
      <div className="block block-products-carousel" data-layout="horizontal">
        <div className="container">
          <div className="section-header">
            <div className="section-header__body">
              ...
              <ul className="section-header__links">
                <li className="section-header__links-item">
                  <a href className="section-header__links-link">
                    Wheel Covers
                  </a>
                </li>
                <li className="section-header__links-item">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
      ...
      <div className="block-space block-space--layout--divider-nl" />
      <div
        className="block block-posts-carousel block-posts-carousel--layout--grid"
        data-layout="grid"
      >
        <div className="container">
          <div className="section-header">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
          ...
          <div className="block-posts-carousel__carousel">
            <OwlCarousel className="owl-theme" items="4">
              <div className="block-posts-carousel__item">
        ...
        <div className="container">
          <ul className="block-brands__list">
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                <img src="/images/brands/brand-1.png" alt />
                <span className="block-brands__item-name">AimParts</span>
              </a>
            </li>
            ...
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">WindEngine</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">TurboElectric</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">StartOne</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">Brandix</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">ABS-Brand</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">GreatCircle</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">JustRomb</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">FastWheels</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">Stroyka-X</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">Mission-51</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">FuelCorp</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">RedGate</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">Blocks</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">BlackBox</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
            <li className="block-brands__item">
              <a href className="block-brands__item-link">
                ...
                <span className="block-brands__item-name">SquareGarage</span>
              </a>
            </li>
            <li className="block-brands__divider" role="presentation" />
          </ul>
      ...
      <div className="block-space block-space--layout--divider-nl d-xl-block d-none" />
      <div className="block block-products-columns">
        <div className="container">
          <div className="row">
            <div className="col-4">
              <div className="block-products-columns__title">
                Top Rated Products
              </div>
